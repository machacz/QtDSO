...
public:
  ...
  /** Access iterator over keys.
      ...
      \endcode
    */
  QMap<QString,QString>::Iterator begin() { return map.begin(); }
  /** Access end value for iterator.
      \see SimpleCfgGroup::begin()
    */
  QMap<QString,QString>::Iterator end()   { return map.end(); }
...
public:
  ...
  /** Access iterator over groups.
      ...
      \see SimpleCfg::end()
    */
  QMap<QString,SimpleCfgGroup *>::Iterator begin() { return map.begin(); }
  /** Access end value for iterator.
      \see SimpleCfg::begin()
    */
  QMap<QString,SimpleCfgGroup *>::Iterator end()   { return map.end(); }
