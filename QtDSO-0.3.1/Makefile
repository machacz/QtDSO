#############################################################################
# Makefile for building: QtDSO
# Generated by qmake (1.07a) (Qt 3.3.5) on: Sun Mar  4 12:47:13 2007
# Project:  QtDSO.pro
# Template: subdirs
# Command: $(QMAKE) -o Makefile QtDSO.pro
#############################################################################
...
Makefile: QtDSO.pro  /usr/lib/qt3/mkspecs/default/qmake.conf 
	$(QMAKE) -o Makefile QtDSO.pro
qmake: qmake_all
	@$(QMAKE) -o Makefile QtDSO.pro
